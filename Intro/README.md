...
The front end transforms the input program into an [intermediate representation (IR)]((https://en.wikipedia.org/wiki/Intermediate_representation)) for further processing by the middle end.
